...
export const PROPERTY_TYPE_CONFIG: PropertyTypeConfig[] = [
  {
    ...
    fields: [
      { key: 'houseName', label: 'House Name (optional)' },
...
export const WIZARD_STEPS = [
  { id: 0, label: 'Personal', icon: '👤', title: 'Personal Information' },
  { id: 1, label: 'Address', icon: '🏠', title: 'Contact & Address' },
  { id: 2, label: 'Family', icon: '👨‍👩‍👧', title: 'Family Details' },
  { id: 3, label: 'Career', icon: '💼', title: 'Education & Career' },
  { id: 4, label: 'Partner', icon: '❤️', title: 'Partner Preferences' },
  { id: 5, label: 'Documents', icon: '📄', title: 'Documents' },
  { id: 6, label: 'Review', icon: '✓', title: 'Review & Submit' },
] as const;
