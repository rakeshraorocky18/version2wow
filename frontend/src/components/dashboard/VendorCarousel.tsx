        ...
        {vendors.length > 0 ? (
          ...
          <div className="wow-empty-state">
            <p className="text-sm font-medium text-[#2C2630]">
              {locationLabel
                ? `No vendor recommendations are available in ${locationLabel} yet.`
                : 'Add your city in profile to see vendor recommendations near you.'}
            </p>
            <Link to="/app/vendors" className="wow-inline-link mt-2 inline-flex">
              Browse all vendors
            </Link>
          </div>
        )}
